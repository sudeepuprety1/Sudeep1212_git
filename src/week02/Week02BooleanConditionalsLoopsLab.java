...
public class Week02BooleanConditionalsLoopsLab {
    ...
    public static void main(String[] args) {
        ...
        //      a. Create two variables called numberOfCookies and numberOfChildren.
             int numberOfCookies = 35;
             int numberOfChildren = 25;
             
             int exactCookies = numberOfCookies % numberOfChildren;
        ...
        //              iv. If there are 5 or more cookies, print "Jackpot!"
               ...
               if (exactCookies <1  ) {System.out.println("Sad Face");}
               else if (exactCookies <2) {System.out.println("Yes!");}
               else if (exactCookies <5 ) {System.out.println("Whoohoooo!");}
               else if (exactCookies >5 ) {System.out.println("Jackpot!");}
